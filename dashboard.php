        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="row no-gutters justify-content-between align-items-end">
                    <div class="profile">
                        <div class="name">Shreya Malwade</div>
                        <div class="email">shreya@gmail.com</div>
            ...
            <div class="property-card property-id-1 row">
                ...
                <div class="content-container col-md-8">
                    ...
                    <div class="detail-container">
                        ...
                        <div class="property-address">Police Beat, hbhjbdhchdbcdb, bbcdhbchbcb,bcddc,dedehbhebjbhe, ceyubuebcebc, 475748</div>
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="button-container col-6">
                            <a href="property-detail.php" class="btn btn-primary">View</a>
                        </div> 
                    </div>
                </div>
            </div>
