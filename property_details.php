...
<body>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb py-2">
            ...
            <li class="breadcrumb-item"><a href="index.html">Mumbai</a></li>
    ...
    <div id="property-images" class="carousel slide" data-ride="carousel">
        <div class="carousel-indicators">
            <li data-bs-target="#property-images" data-slide-to="0" class="active" ></li>
            <li data-bs-target="#property-images" data-slide-to="1" class=""></li>
            <li data-bs-target="#property-images" data-slide-to="2" class=""></li>
        </div>
